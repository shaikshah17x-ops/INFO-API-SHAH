...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "IND":
        return "uid=5085444599&password=SHAH_7RZ3Q--BY-IRJGFB"
    elif r == "ME":
        return "uid=your_uid_MIDDLE_EAST&password=your_password"
    elif r in {"BR", "US", "SAC", "NA"}:
        return "uid=your_uid_brazil&password=password"
    else:
        return "uid=your_uid_NORTH_AMERICA&password=your_password"
